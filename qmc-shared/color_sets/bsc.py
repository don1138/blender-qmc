...
class BS629_Dark_Camouflage_Grey_Quacker_Grey(bpy.types.Operator):
    """629 Dark Camouflage Grey / Quacker Grey"""
    bl_label = "629 Dark Camouflage Grey / Quacker Grey"
...
class BSC381CPanel(bpy.types.Panel):
    ...
    def draw(self, context):
        ...
        scol.operator("color.629_dark_camouflage_grey_quacker_grey", text="629 Dark Camouflage Grey / Quacker Grey")
...
array_bsc = [
    ...
    BS629_Dark_Camouflage_Grey_Quacker_Grey,
    BS630_French_Grey,
    BS631_Light_Grey,
