...
class AMSPanel(bpy.types.Panel):
    ...
    bl_label = "Aerospace Material Specification"
...
# AMS GLOSS BROWN PANEL
class AMSGlossBrownPanel(bpy.types.Panel):
    bl_idname = "AMS_GLOSS_BROWN_PT_Panel"
...
# AMS GLOSS RED PANEL
class AMSGlossRedPanel(bpy.types.Panel):
    bl_idname = "AMS_GLOSS_RED_PT_Panel"
    bl_label = "        Gloss Red"
    bl_space_type = "VIEW_3D"
    bl_region_type = "UI"
    bl_category = "MAT"
...
# AMS GLOSS ORANGE PANEL
class AMSGlossOrangePanel(bpy.types.Panel):
    bl_idname = "AMS_GLOSS_ORANGE_PT_Panel"
...
# AMS GLOSS YELLOW PANEL
class AMSGlossYellowPanel(bpy.types.Panel):
    bl_idname = "AMS_GLOSS_YELLOW_PT_Panel"
...
# AMS GLOSS GREEN PANEL
class AMSGlossGreenPanel(bpy.types.Panel):
    bl_idname = "AMS_GLOSS_GREEN_PT_Panel"
...
# AMS GLOSS BLUE PANEL
class AMSGlossBluePanel(bpy.types.Panel):
    bl_idname = "AMS_GLOSS_BLUE_PT_Panel"
    bl_label = "        Gloss Blue"
    bl_space_type = "VIEW_3D"
    bl_region_type = "UI"
    bl_category = "MAT"
...
# AMS GLOSS GREY PANEL
class AMSGlossGreyPanel(bpy.types.Panel):
    bl_idname = "AMS_GLOSS_GREY_PT_Panel"
    bl_label = "        Gloss Grey"
    bl_space_type = "VIEW_3D"
    bl_region_type = "UI"
    bl_category = "MAT"
...
# AMS GLOSS MISC PANEL
class AMSGlossMiscPanel(bpy.types.Panel):
    bl_idname = "AMS_GLOSS_MISC_PT_Panel"
    bl_label = "        Gloss Misc"
    bl_space_type = "VIEW_3D"
    bl_region_type = "UI"
    bl_category = "MAT"
...
# AMS SEMIGLOSS BROWN PANEL
class AMSSemiGlossBrownPanel(bpy.types.Panel):
    bl_idname = "AMS_SEMIGLOSS_BROWN_PT_Panel"
...
# AMS SEMIGLOSS RED PANEL
class AMSSemiGlossRedPanel(bpy.types.Panel):
    bl_idname = "AMS_SEMIGLOSS_RED_PT_Panel"
...
# AMS SEMIGLOSS ORANGE PANEL
class AMSSemiGlossOrangePanel(bpy.types.Panel):
    bl_idname = "AMS_SEMIGLOSS_ORANGE_PT_Panel"
...
# AMS SEMIGLOSS YELLOW PANEL
class AMSSemiGlossYellowPanel(bpy.types.Panel):
    bl_idname = "AMS_SEMIGLOSS_YELLOW_PT_Panel"
...
# AMS SEMIGLOSS GREEN PANEL
class AMSSemiGlossGreenPanel(bpy.types.Panel):
    bl_idname = "AMS_SEMIGLOSS_GREEN_PT_Panel"
...
# AMS SEMIGLOSS BLUE PANEL
class AMSSemiGlossBluePanel(bpy.types.Panel):
    bl_idname = "AMS_SEMIGLOSS_BLUE_PT_Panel"
...
# AMS SEMIGLOSS GREY PANEL
class AMSSemiGlossGreyPanel(bpy.types.Panel):
    bl_idname = "AMS_SEMIGLOSS_GREY_PT_Panel"
...
# AMS SEMIGLOSS MISC PANEL
class AMSSemiGlossMiscPanel(bpy.types.Panel):
    bl_idname = "AMS_SEMIGLOSS_MISC_PT_Panel"
...
# AMS SEMIGLOSS FLUORESCENT PANEL
class AMSSemiGlossFluorescentPanel(bpy.types.Panel):
    bl_idname = "AMS_SEMIGLOSS_FLUORESCENT_PT_Panel"
...
# AMS GLOSS BROWN PANEL
class AMSMatteBrownPanel(bpy.types.Panel):
    bl_idname = "AMS_MATTE_BROWN_PT_Panel"
...
# AMS GLOSS RED PANEL
class AMSMatteRedPanel(bpy.types.Panel):
    bl_idname = "AMS_MATTE_RED_PT_Panel"
    bl_label = "        Matte Red"
    bl_space_type = "VIEW_3D"
    bl_region_type = "UI"
    bl_category = "MAT"
...
# AMS GLOSS ORANGE PANEL
class AMSMatteOrangePanel(bpy.types.Panel):
    bl_idname = "AMS_MATTE_ORANGE_PT_Panel"
...
# AMS GLOSS YELLOW PANEL
class AMSMatteYellowPanel(bpy.types.Panel):
    bl_idname = "AMS_MATTE_YELLOW_PT_Panel"
...
# AMS GLOSS GREEN PANEL
class AMSMatteGreenPanel(bpy.types.Panel):
    bl_idname = "AMS_MATTE_GREEN_PT_Panel"
...
# AMS GLOSS BLUE PANEL
class AMSMatteBluePanel(bpy.types.Panel):
    bl_idname = "AMS_MATTE_BLUE_PT_Panel"
    bl_label = "        Matte Blue"
    bl_space_type = "VIEW_3D"
    bl_region_type = "UI"
    bl_category = "MAT"
...
# AMS GLOSS GREY PANEL
class AMSMatteGreyPanel(bpy.types.Panel):
    bl_idname = "AMS_MATTE_GREY_PT_Panel"
    bl_label = "        Matte Grey"
    bl_space_type = "VIEW_3D"
    bl_region_type = "UI"
    bl_category = "MAT"
...
# AMS GLOSS MISC PANEL
class AMSMatteMiscPanel(bpy.types.Panel):
    bl_idname = "AMS_MATTE_MISC_PT_Panel"
    bl_label = "        Matte Misc"
    bl_space_type = "VIEW_3D"
    bl_region_type = "UI"
    bl_category = "MAT"
...
# AMS GLOSS FLUORESCENT PANEL
class AMSMatteFluorescentPanel(bpy.types.Panel):
    bl_idname = "AMS_MATTE_FLUORESCENT_PT_Panel"
...
array_ams = [
    ...
    AMSGlossMiscPanel,
    AMSSemiGlossPanel,
    AMSSemiGlossBrownPanel,
    AMSSemiGlossRedPanel,
    AMSSemiGlossOrangePanel,
    AMSSemiGlossYellowPanel,
    AMSSemiGlossGreenPanel,
    AMSSemiGlossBluePanel,
    AMSSemiGlossGreyPanel,
    AMSSemiGlossMiscPanel,
    AMSSemiGlossFluorescentPanel,
    AMSMattePanel,
    AMSMatteBrownPanel,
    AMSMatteRedPanel,
    AMSMatteOrangePanel,
