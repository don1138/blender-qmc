...
Grab ``pcoy_panel.py`` and ``mcmc_panel.py`` from the repo, or download the latest ZIP from **Releases** and unzip it in a local folder.

Install each file separately via ``Edit > Preferences > Add-ons > Install…``.
