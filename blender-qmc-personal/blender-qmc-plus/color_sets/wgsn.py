...
class WGSN_Russet(bpy.types.Operator):
    """Russet (Coloro 013-30-24)"""
    bl_label = "Russet"
    bl_idname = "color.wgsn_russet"

    def execute(self, context):
        set_base_color(0x7c3330, self.bl_label)
        return {'FINISHED'}


class WGSN_PeacefulLilac(bpy.types.Operator):
    """Peaceful Lilac (Coloro 135-78-11)"""
    bl_label = "Peaceful Lilac"
    bl_idname = "color.wgsn_peaceful_lilac"

    def execute(self, context):
        set_base_color(0xc9c5df, self.bl_label)
        return {'FINISHED'}


class WGSN_Maize(bpy.types.Operator):
    """Maize (Coloro 036-65-23)"""
    bl_label = "Maize"
    bl_idname = "color.wgsn_maize"

    def execute(self, context):
        set_base_color(0xcfa15b, self.bl_label)
        return {'FINISHED'}


class WGSN_DeepGreen(bpy.types.Operator):
    """Deep Green (Coloro 082-30-14)"""
    bl_label = "Deep Green"
    bl_idname = "color.wgsn_deep_green"

    def execute(self, context):
        set_base_color(0x1c5247, self.bl_label)
        return {'FINISHED'}
...
class WGSN_RadiantEarth(bpy.types.Operator):
    ...
    def execute(self, context):
        set_base_color(0xba4433, self.bl_label)
        return {'FINISHED'}


class WGSN_SereneGreen(bpy.types.Operator):
    """Serene Green (Coloro 076-86-07)"""
    bl_label = "Serene Green"
    bl_idname = "color.wgsn_serene_green"

    def execute(self, context):
        set_base_color(0xcee2d7, self.bl_label)
        return {'FINISHED'}


class WGSN_PositivelyYellow(bpy.types.Operator):
    """Positively Yellow (Coloro 043-85-34)"""
    bl_label = "Positively Yellow"
    bl_idname = "color.wgsn_positively_yellow"

    def execute(self, context):
        set_base_color(0xffdb39, self.bl_label)
        return {'FINISHED'}


class WGSN_FlourishPink(bpy.types.Operator):
    """Flourish Pink (Coloro 012-65-24)"""
    bl_label = "Flourish Pink"
    bl_idname = "color.wgsn_flourish_pink"

    def execute(self, context):
        set_base_color(0xf18d85, self.bl_label)
        return {'FINISHED'}


class WGSN_OfflineBlue(bpy.types.Operator):
    """Offline Blue (Coloro 123-52-27)"""
    bl_label = "Offline Blue"
    bl_idname = "color.wgsn_offline_blue"

    def execute(self, context):
        set_base_color(0x5c85bd, self.bl_label)
        return {'FINISHED'}
...
class WGSNPanel2020(bpy.types.Panel):
    bl_idname = "WGSN_2020_PT_Panel"
    bl_label = "2020"
    bl_space_type = "VIEW_3D"
    bl_region_type = "UI"
    bl_category = "MAT"
...
class WGSNPanel2021(bpy.types.Panel):
    bl_idname = "WGSN_2021_PT_Panel"
    bl_label = "2021"
    bl_space_type = "VIEW_3D"
    bl_region_type = "UI"
    bl_category = "MAT"
...
class WGSNPanel2022(bpy.types.Panel):
    bl_idname = "WGSN_2022_PT_Panel"
    bl_label = "2022"
    bl_space_type = "VIEW_3D"
    bl_region_type = "UI"
    bl_category = "MAT"
...
class WGSNPanel2023(bpy.types.Panel):
    bl_idname = "WGSN_2023_PT_Panel"
    bl_label = "2023"
    bl_space_type = "VIEW_3D"
    bl_region_type = "UI"
    bl_category = "MAT"
...
class WGSNPanel2024(bpy.types.Panel):
    bl_idname = "WGSN_2024_PT_Panel"
    bl_label = "2024"
    bl_space_type = "VIEW_3D"
    bl_region_type = "UI"
    bl_category = "MAT"
...
class WGSNPanel2025(bpy.types.Panel):
    bl_idname = "WGSN_2025_PT_Panel"
    bl_label = "2025"
    bl_space_type = "VIEW_3D"
    bl_region_type = "UI"
    bl_category = "MAT"
...
class WGSNPanel2026(bpy.types.Panel):
    bl_idname = "WGSN_2026_PT_Panel"
    bl_label = "2026"
    bl_space_type = "VIEW_3D"
    bl_region_type = "UI"
    bl_category = "MAT"
...
class WGSNPanel2027(bpy.types.Panel):
    bl_idname = "WGSN_2027_PT_Panel"
    bl_label = "2027"
    bl_space_type = "VIEW_3D"
    bl_region_type = "UI"
    bl_category = "MAT"
    ...
    def draw(self, context):
        ...
        scol.label(text="", icon_value=g.c_icons["wgsn_russet"].icon_id)
        scol.label(text="", icon_value=g.c_icons["wgsn_peaceful_lilac"].icon_id)
        scol.label(text="", icon_value=g.c_icons["wgsn_maize"].icon_id)
        scol.label(text="", icon_value=g.c_icons["wgsn_deep_green"].icon_id)
        ...
        scol.operator("color.wgsn_russet", text="Russet")
        scol.operator("color.wgsn_peaceful_lilac", text="Peaceful Lilac")
        scol.operator("color.wgsn_maize", text="Maize")
        scol.operator("color.wgsn_deep_green", text="Deep Green")


# 2028 PANEL

class WGSNPanel2028(bpy.types.Panel):
    bl_idname = "WGSN_2028_PT_Panel"
    bl_label = "2028"
    bl_space_type = "VIEW_3D"
    bl_region_type = "UI"
    bl_category = "MAT"
    ...
    def draw(self, context):
        ...
        scol = srow.column(align=True)
        scol.scale_y = 1.25
        scol.label(text="", icon_value=g.c_icons["wgsn_radiant_earth"].icon_id)
        scol.label(text="", icon_value=g.c_icons["wgsn_serene_green"].icon_id)
        scol.label(text="", icon_value=g.c_icons["wgsn_positively_yellow"].icon_id)
        scol.label(text="", icon_value=g.c_icons["wgsn_flourish_pink"].icon_id)
        scol.label(text="", icon_value=g.c_icons["wgsn_offline_blue"].icon_id)

        scol = srow.column(align=True)
        scol.scale_y = 1.25
        scol.scale_x = 3.0
        scol.operator("color.wgsn_radiant_earth", text="Radiant Earth")
        scol.operator("color.wgsn_serene_green", text="Serene Green")
        scol.operator("color.wgsn_positively_yellow", text="Positively Yellow")
        scol.operator("color.wgsn_flourish_pink", text="Flourish Pink")
        scol.operator("color.wgsn_offline_blue", text="Offline Blue")
